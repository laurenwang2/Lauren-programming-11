...
public class Main {
    /*this program lets user to add, delete, and insert student name and number into the original student data i have created*/
    public static void main(String[] args) {
        //original array, initialized 2D array, each student has their own student number
        ...
        while (true) { //this while loop is to repeat the switch statement so the user can switch between methods
            ...
            //switch statement to decide which method the user would like to use
            switch (userChoice) {
                //lets user delete values from the end of the original array
                case "Delete":
                ...
                //let user add elements into the end of the original array
                case "Add":
                    //get user input
                    ...
                    //let user insert value into the original array at chosen index position
                case "Insert":
                    //get user inputs
